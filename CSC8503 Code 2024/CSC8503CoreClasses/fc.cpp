#include "C:/Users/mlhum/source/repos/CSC8503-NetworkCodebase/CSC8503 Code 2024/CSC8503CoreClasses/CMakeFiles/CSC8503CoreClasses.dir/Debug/cmake_pch.hxx"
#include "fc.h"
...
FollowConstraint::FollowConstraint(GameObject* a, GameObject* b, float d)
{
	objectA = a;
	objectB = b;
	distance = d;
...
FollowConstraint::~FollowConstraint()
{
...
void FollowConstraint::UpdateConstraint(float dt) {
